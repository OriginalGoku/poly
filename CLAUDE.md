...
- **Polymarket Sports WS observed leagues** (sniffed 2026-03-25): `atp`, `cbb`, `challenger`, `mlb`, `nba`, `nhl`. CBB was added mid-day on 2026-03-25 (not present in earlier sniff, appeared during later Sweet 16 games). Sports WS coverage may expand over time — re-sniff if a new sport is needed.
